      ...
      body: BlocProvider<StartExamCubit>(
        ...
        child: BlocBuilder<StartExamCubit, StartExamStates>(
          builder: (context, state) {
            ...
            if (getExamState?.data == null &&
                getExamState?.isLoading == false) {
              UIUtils.hideEasyLoading();
              return Center(
                child: Text(
                  UiConstants.missingExamDetails,
            ...
            } else if (getExamState?.errorMessage != null &&
                getExamState?.isLoading == false) {
              UIUtils.hideEasyLoading();
              return Center(
                child: Text(
                  getExamState!.errorMessage!,
                  style: getMediumStyle(
                    color: ColorManager.black,
                    fontSize: Sizes.s18.sp,
                    fontFamily: GoogleFontsKeys.inter,
            ...
            } else if (getExamState?.data != null &&
                getExamState?.isLoading == false) {
              UIUtils.hideEasyLoading();
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Image.asset(
                                ImageAssets.examImage,
                                width: Sizes.s42.w,
                                height: Sizes.s47.h,
                              ),
                              Text(
                                getExamState!.data!.title!,
                              ...
                              Spacer(),
                              Text(
                                getExamState.data!.duration.toString() +
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                getExamState.data!.numberOfQuestions
                                        .toString() +
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            UiConstants.instructionsHeader,
                            style: getMediumStyle(
                              color: ColorManager.black,
                              fontSize: Sizes.s18.sp,
                              fontFamily: GoogleFontsKeys.inter,
                          ...
                          CustomElevatedButton(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                context,
                                Routes.questions,
                                arguments: getExamState.data!.id,
                              );
                            },
                          ),
                        ],
